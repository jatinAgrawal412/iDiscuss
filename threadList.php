...
<body>
    ...
    <div class="container  mb-3" id="ques">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <fieldset>
            <a href="users.php?userid=' . $th_user_id . '"><img src="data:image;base64,' . base64_encode($row_user['pic']) . '" width="50px" alt="..."></a>
            </div>
        ...
        if ($totalRows > 0) {
            ...
            <ul class="pagination">';
            if ($page > 1) {
                echo '<li class="page-item"><a class="btn btn-success mx-1" href="threadList.php?catid=' . $id . '&page=' . $page - 1 . '">Previous</a></li>';
            }
            else{
                echo '<li class="page-item"><a class="btn btn-success mx-1 disabled" href="threadList.php?catid=' . $id . '&page=' . $page - 1 . '">Previous</a></li>';
            }
            for ($i = 1; $i <= $total_page; $i++) {
                if ($page == $i) {
                    echo '<li class="page-item"><a class="btn btn-outline-success mx-1" href="threadList.php?catid=' . $id . '&page=' . $i . '">' . $i . '</a></li>';
                } else {
                    echo '<li class="page-item"><a class="btn btn-success mx-1" href="threadList.php?catid=' . $id . '&page=' . $i . '">' . $i . '</a></li>';
                }
            }
            if ($page < $total_page) {
                echo '<li class="page-item"><a class="btn btn-success mx-1" href="threadList.php?catid=' . $id . '&page=' . $page + 1 . '">Next</a></li>';
            }
            else{
                echo '<li class="page-item"><a class="btn btn-success mx-1 disabled" href="threadList.php?catid=' . $id . '&page=' . $page + 1 . '">Next</a></li>';
            }
            echo '
            </ul>
            </nav>';
